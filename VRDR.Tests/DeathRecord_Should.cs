...
//               Exception ex = Assert.Throws<System.ArgumentException>(() => new DeathRecord(File.ReadAllText(FixturePath("fixtures/json/DeathRecord1.json"))));  
         ...
         //   Assert.Equal("Error: Unable to find IJE DPLACE mapping for FHIR DeathLocationType field value 440081000124100x", ex.Message.Substring(96));
            Assert.IsTrue(ex.Message.Contains("Error: Unable to find IJE DPLACE mapping for FHIR DeathLocationType field value '440081000124100x'"));
...
//             Console.WriteLine("*** dr.deathLocationName ***="+dr.DeathLocationName); 
//             Console.WriteLine("*** dr.deathLocationType[code] ***="+dr.DeathLocationType["code"]);
//             Console.WriteLine("*** dr.deathLocationType[system] ***="+dr.DeathLocationType["system"]);
//             Console.WriteLine("*** dr.deathLocationType[display] ***="+dr.DeathLocationType["display"]);
            
//             Console.WriteLine("*** dr.deathLocationJurisdiction ***="+dr.DeathLocationJurisdiction);
//             Console.WriteLine("*** dr.deathLocationDescription ***="+dr.DeathLocationDescription);
//             Console.WriteLine("*** dr.DeathLocationAddress ***="+dr.DeathLocationAddress);
//              Console.WriteLine("*** dr.CausesOfDeath ***="+dr.CausesOfDeath);
            
//             Console.WriteLine("*** dr.CausesOfDeath.Length ***="+dr.CausesOfDeath.Length);
//             //Console.WriteLine("*** dr.CausesOfDeath[1].Item2 ***="+dr.CausesOfDeath[1].Item2);
            
            
// //             Console.WriteLine("*** dr.CausesOfDeathItem2 ***="+dr.CausesOfDeath.Item2);
// //             Console.WriteLine("*** dr.CausesOfDeathItem3 ***="+dr.CausesOfDeath.Item3);
// //              Console.WriteLine("*** dr.CausesOfDeath[1] ***="+dr.CausesOfDeath[1]);
            
// //             foreach (KeyValuePair<string, string> item in dr.DeathLocationType)
// //            {
// //               Console.Write(item.Key+"=>" + item.Value.ToString());               
// //            }     
//             Console.WriteLine("*** dr.deathLocationTypeHelper ***="+dr.DeathLocationTypeHelper);            
//             Console.WriteLine("*** dr.CausesOfDeath ***="+dr.CausesOfDeath);
            
           
//             dr.DeathLocationTypeHelper = "450391000124102";//"63238001";
//             IJEMortality ije = new IJEMortality(dr);
//             Console.WriteLine("*** ije.COD ***="+ije.COD); 
//             Console.WriteLine("*** ije.COD1A ***="+ije.COD1A);
//             Console.WriteLine("*** ije.COD1B ***="+ije.COD1B);
//             Console.WriteLine("*** ije.COD1C ***="+ije.COD1C);
//             Console.WriteLine("*** ije.COD1D ***="+ije.COD1D);

//             Console.WriteLine("*** ije.DPLACE ***="+ije.DPLACE);
//             ///Assert.Equal("4", ije.DPLACE);
//             //dr.DeathLocationTypeHelper = "440071000124103";
//             // Console.WriteLine("*** ije.DPLACE2 ***="+new IJEMortality(dr).DPLACE);
...
//             dr = new DeathRecord();
//             dr.DeathLocationAddress = dtladdress;
//             dr.DeathLocationJurisdiction = "MA";
//             dr.DeathLocationType["display"] = "Death at school";
            
// //             Assert.Equal("Middlesex", dr.DeathLocationAddress["addressCounty"]);
// //             Assert.Equal("123", dr.DeathLocationAddress["addressCountyC"]);
            
//             IJEMortality ije1 = new IJEMortality(dr);
//             ije1.DPLACE = "11";
//             Console.WriteLine("*1** ije.COD ***="+ije1.COD); 
//             Console.WriteLine("*1** ije.COD1A ***="+ije1.COD1A);
//             Console.WriteLine("*1** ije.COD1B ***="+ije1.COD1B);
//             Console.WriteLine("*1** ije.COD1C ***="+ije1.COD1C);
//             Console.WriteLine("*1** ije.COD1D ***="+ije1.COD1D);
//             Console.WriteLine("*1** ije.DPLACE ***="+ije1.DPLACE);
//             Console.WriteLine("*** dr.deathLocationType[display] ***="+dr.DeathLocationType["display"]);
...
// //             if (mapping.ContainsKey("16983000")) Console.WriteLine("** LEGIT **"); 
// //            Exception ex = Assert.Throws<System.ArgumentException>(() => new DeathRecord("baddData"));
            
//             dr.DeathLocationTypeHelper = "450391000124102";
//             Console.WriteLine("*2** ije.DPLACE ***="+ije1.DPLACE);
            
//             // Console.WriteLine("*** ije.COD ***="+new IJEMortality(dr).COD);
//             //Console.WriteLine("*** ije.COD ***="+new IJEMortality(dr).COD);
//             //Exception ex = Assert.Throws<System.ArgumentException>(() => new IJEMortality(dr));
