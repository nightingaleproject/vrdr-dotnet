namespace VRDR
{
    ...
    public static class CodeSystems
    {
        ...
        /// <summary>PHINVADS Place Of Death.</summary>
        public static string PH_PlaceOfDeath = "urn:oid:2.16.840.1.114222.4.11.7216"; // Should this use http://snomed.info/sct ?
