...
namespace VRDR
{
    ...
    /// <summary>FILENO</summary>
    /// <value>uint </value>
    public uint? FILENO
    {
      get
      {
          return GetParameterUnsignedInt( "FILENO");
      }
      set
      {
            SetParameterUnsignedInt(value, "FILENO");
      }
    }
    /// <summary>DOD_YR</summary>
    /// <value>uint </value>
    public uint? DOD_YR
    {
      get
      {
          return GetParameterUnsignedInt( "DOD_YR");
      }
      set
      {
            SetParameterUnsignedInt(value, "DOD_YR");
      }
    }
    /// <summary>AUXNO</summary>
    /// <value>string </value>
    public string AUXNO
    {
      get
      {
          return GetParameterString( "AUXNO");
      }
      set
      {
            SetParameterString(value, "AUXNO");
      }
    }
    /// <summary>SSN</summary>
    /// <value>string </value>
