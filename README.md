...
<td style="text-align: center;"><a href="https://www.nuget.org/packages/VRDR/4.0.2">nuget</a> <a href="https://github.com/nightingaleproject/vrdr-dotnet/releases/tag/4.0.2"> github</a></td>
<td style="text-align: center;"><a href="https://www.nuget.org/packages/VRDR.Messaging/4.0.2">nuget</a> <a href="https://github.com/nightingaleproject/vrdr-dotnet/releases/tag/4.0.2"> github</a></td>
</tr>
<tr>
...
<ItemGroup>
  ...
  <PackageReference Include="VRDR" Version="4.0.2" />
  ...
</ItemGroup>
```
...
<ItemGroup>
  ...
  <PackageReference Include="VRDR.Messaging" Version="4.0.2" />
  ...
</ItemGroup>
```
