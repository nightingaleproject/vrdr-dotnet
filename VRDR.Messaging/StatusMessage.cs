...
namespace VRDR
{
    ...
    public class StatusMessage : BaseMessage
    {
        ...
        public StatusMessage(BaseMessage messageToStatus, string status) : this(messageToStatus?.MessageId, messageToStatus?.MessageDestination, status, messageToStatus?.MessageSource)
        {
