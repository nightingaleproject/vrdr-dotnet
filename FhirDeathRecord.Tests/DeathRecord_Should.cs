...
{
    public class DeathRecord_Should : IClassFixture<DeathRecordFixture>
    {
        ...
        public DeathRecord_Should(DeathRecordFixture fixture)
        {
            XMLRecords = fixture.XMLRecords;
            JSONRecords = fixture.JSONRecords;
